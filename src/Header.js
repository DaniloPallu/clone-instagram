...
<div className="header">
        <div className="modalCriarConta">
          ...
          <form onSubmit={(e)=>criarConta(e)}>
            <input id="email-cadastro" type="text" placeholder="Insira seu e-mail"/>
            <input id="username-cadastro" type="text" placeholder="Insira seu username"/>
            <input id="senha-cadastro" type="password" placeholder="Insira sua senha"/>
      ...
      <div className="modalUpload">
          ...
          <form id='form-upload' onSubmit={(e)=>uploadPost(e)}>
            ...
            <input id="descricao-upload" type="text" placeholder="Descricao da foto"/>
        ...
        <div className="center">
          <div className="header_logo">
            <a href=""> <img src= "https://instagram.com/static/images/web/mobile_nav_type_logo.png/735145cfe0a4.png"/> </a>
          </div>
        {
          (props.user)?
